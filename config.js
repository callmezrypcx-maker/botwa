...
/*============= MAIN INFO =============*/
global.owner = [['62xx', 'Allen', true]]
global.mods = []
global.prems = []
global.nomorbot = '62xx' // ubah pake no kalian
global.nomorown = '62xx'// ubah pake no kalian
...
global.author = 'Allen'
global.namebot = 'Teramokari - ai'
global.wm = 'Allen'
global.watermark = wm
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.stickpack = `Sticker Dibuat dengan ${namebot}\n\nRyoYamada-MD ESM\n+${nomorbot}`
global.stickauth = `Made By Allen`
